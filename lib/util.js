...
function saveNumber(){
 ...
 function randomNumbersGet25np() {
  fileToMap();
  console.log('npMap.size='+npMap.size);//--------------検証用
...
//　（randomNumbersGet25  → 2,5で割り切れないものは出さない）
function getNumbersArray(){
  //let array = func.randomNumbersGet25(max, kosuu, npMap).n;
  let array = randomNumbersGet25np().n;
  return array;
}

function getMaxNow(){
  //let maxNow = func.randomNumbersGet25(max, kosuu, npMap).maxNow;
